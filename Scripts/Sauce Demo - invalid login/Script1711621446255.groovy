...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Swag Labs/input_Swag Labs_password'), 'qcu24s4901EY+Whz5I1ihQ==')

WebUI.click(findTestObject('Object Repository/Page_Swag Labs/input_Swag Labs_login-button'))

WebUI.delay(2)

WebUI.verifyElementVisible(findTestObject('Page_Swag Labs/div_Epic sadface Username and password do not match any user in this service'))
